...
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0C40 (size: 0x8)
    class UCapsuleComponent* DeadColllision;                                          // 0x0C48 (size: 0x8)
    class UBP_PalTimerPointLightComponent_C* PlayerLight;                             // 0x0C50 (size: 0x8)
    class UPalRiderComponent* Rider Component;                                        // 0x0C58 (size: 0x8)
    bool bIsInCapturedCage;                                                           // 0x0C60 (size: 0x1)
    class ABP_Lamp_C* Lantern;                                                        // 0x0C68 (size: 0x8)
