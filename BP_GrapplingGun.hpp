...
class ABP_GrapplingGun_C : public APalWeaponBase
{
    ...
    bool IsShooting;                                                                  // 0x0588 (size: 0x1)
    FHitResult GrappleEnd;                                                            // 0x0590 (size: 0xE8)
    FVector GrappleLocation;                                                          // 0x0678 (size: 0x18)
    bool IsEquip;                                                                     // 0x0690 (size: 0x1)
    double CableMaxLength;                                                            // 0x0698 (size: 0x8)
    double CableShootSpeed;                                                           // 0x06A0 (size: 0x8)
    double CableReturnSpeed;                                                          // 0x06A8 (size: 0x8)
    double PlayerMoveSpeed;                                                           // 0x06B0 (size: 0x8)
    FVector ShootDirection;                                                           // 0x06B8 (size: 0x18)
    bool IsPull;                                                                      // 0x06D0 (size: 0x1)
    FVector StartLocation;                                                            // 0x06D8 (size: 0x18)
    FVector GrappleMoveEndLocation;                                                   // 0x06F0 (size: 0x18)
    FVector HitNormal;                                                                // 0x0708 (size: 0x18)
    bool IsVisibleReticle;                                                            // 0x0720 (size: 0x1)
    class ABP_GrapplingGun_Bullet_C* Bullet;                                          // 0x0728 (size: 0x8)
    double NearCoolTimeDistance;                                                      // 0x0730 (size: 0x8)
    double NearCoolTimeRate;                                                          // 0x0738 (size: 0x8)
