...
class UWBP_Control_Settings_C : public UUserWidget
{
    ...
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_UI_MinFontSize;       // 0x0330 (size: 0x8)
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_UI_ReticleColor;      // 0x0338 (size: 0x8)
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_UI_ReticleOutlineOpacity; // 0x0340 (size: 0x8)
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_UI_TutorialDisplay;   // 0x0348 (size: 0x8)
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_Vibration;            // 0x0350 (size: 0x8)
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_X;                    // 0x0358 (size: 0x8)
    class UWBP_OptionSettings_ListContent_C* WBP_OptionSettings_Y;                    // 0x0360 (size: 0x8)
    FPalOptionAudioSettings AudioSettingCache;                                        // 0x0368 (size: 0x1C)
    TArray<FDataTableRowHandle> LevelMsgIds;                                          // 0x0388 (size: 0x10)
    bool SomethingChanged;                                                            // 0x0398 (size: 0x1)
    FPalOptionKeyboardSettings KeyboardSettingCache;                                  // 0x039C (size: 0x14)
    FPalOptionLocalStaticSettings LocalStaticSettingCache;                            // 0x03B0 (size: 0xA8)
    FPalOptionPadSettings PadSettingCache;                                            // 0x0458 (size: 0x1C)
    TArray<class UVerticalBox*> VerticalBoxs;                                         // 0x0478 (size: 0x10)
    TArray<class UWBP_PalCommonButtonBase_C*> FirstRows;                              // 0x0488 (size: 0x10)
    int32 Current;                                                                    // 0x0498 (size: 0x4)
    FPalOptionUISettings UISettingCache;                                              // 0x049C (size: 0x1C)
    FPalOptionCommonSettings CommonSettingCache;                                      // 0x04B8 (size: 0x30)
    TArray<FDataTableRowHandle> ColorSelections;                                      // 0x04E8 (size: 0x10)
