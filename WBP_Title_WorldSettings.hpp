...
class UWBP_Title_WorldSettings_C : public UPalUserWidget
{
    ...
    class UWBP_Title_WorldSettings_ListContent_C* WorldSettings_SupplyDropSpan;       // 0x05D8 (size: 0x8)
    class UWBP_Title_WorldSettings_ListContent_C* WorldSettings_WorldName;            // 0x05E0 (size: 0x8)
    FWBP_Title_WorldSettings_COnClickedCancel OnClickedCancel;                        // 0x05E8 (size: 0x10)
    void OnClickedCancel();
    FWBP_Title_WorldSettings_COnClickedConfirm OnClickedConfirm;                      // 0x05F8 (size: 0x10)
    void OnClickedConfirm();
    bool IsCustomDifficultySetting;                                                   // 0x0608 (size: 0x1)
    FPalOptionWorldStaticSettings SatticWorldSetting;                                 // 0x060C (size: 0x108)
    FPalOptionWorldSettings CachedOriginalWorldSetting;                               // 0x0718 (size: 0x160)
    FPalOptionWorldSettings EditedWorldSetting;                                       // 0x0878 (size: 0x160)
    bool IsEditedSettingFlag;                                                         // 0x09D8 (size: 0x1)
    bool IsEditedFromPreset;                                                          // 0x09D9 (size: 0x1)
    bool Is New World;                                                                // 0x09DA (size: 0x1)
    FWBP_Title_WorldSettings_COnClickedWorldNameInputButton OnClickedWorldNameInputButton; // 0x09E0 (size: 0x10)
    void OnClickedWorldNameInputButton();
    FWBP_Title_WorldSettings_COnClickedRandomizerSeedInputButton OnClickedRandomizerSeedInputButton; // 0x09F0 (size: 0x10)
