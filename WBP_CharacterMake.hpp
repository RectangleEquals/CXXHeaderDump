...
class UWBP_CharacterMake_C : public UPalUICharacterMakeBase
{
    ...
    FPalDataTableRowName_UIInputAction ToggleEquipDisplayInputAction;                 // 0x06D8 (size: 0x8)
    FPalDataTableRowName_UIInputAction PlaySampleVoiceInInputAction;                  // 0x06E0 (size: 0x8)
    FPalUIActionBindData PlaySampleVoiceActionHandle;                                 // 0x06E8 (size: 0x4)
    bool IsCachingMakeData;                                                           // 0x06EC (size: 0x1)
    class UBP_PalPlayerDataCharacterMake_C* CharacterMakeData;                        // 0x06F0 (size: 0x8)
    FName flagName;                                                                   // 0x06F8 (size: 0x8)
    bool NowDisplayEquip;                                                             // 0x0700 (size: 0x1)
