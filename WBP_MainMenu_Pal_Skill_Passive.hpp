...
class UWBP_MainMenu_Pal_Skill_Passive_C : public UUserWidget
{
    ...
    class UWidgetAnimation* Anm_Rare2_Normal;                                         // 0x02C8 (size: 0x8)
    class UWidgetAnimation* Anm_Rare_Normal;                                          // 0x02D0 (size: 0x8)
    class UImage* IconRankArrow;                                                      // 0x02D8 (size: 0x8)
    class UImage* Image_Selected_1;                                                   // 0x02E0 (size: 0x8)
