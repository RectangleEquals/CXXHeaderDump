...
class UBP_PalGameInstance_C : public UPalGameInstance
{
    ...
    class ULoadingProcessTask* CurrentLoadingTask;                                    // 0x07D8 (size: 0x8)
    class UPalHUDDispatchParameter_FadeWidget* LoadingFadeParameter;                  // 0x07E0 (size: 0x8)
    TSoftObjectPtr<UWorld> LoadWorld;                                                 // 0x07E8 (size: 0x30)
    bool ShowedCharaMake;                                                             // 0x0818 (size: 0x1)
    TSoftClassPtr<APalCutsceneActor> OpeningActor;                                    // 0x0820 (size: 0x30)
    FName CutsceneName;                                                               // 0x0850 (size: 0x8)
    class APalCutsceneActor* OpeningCutscene;                                         // 0x0858 (size: 0x8)
    FName flagName;                                                                   // 0x0860 (size: 0x8)
    int32 PlayingID;                                                                  // 0x0868 (size: 0x4)
    FDataTableRowHandle CreateSessionErrorMsgId;                                      // 0x0870 (size: 0x10)
