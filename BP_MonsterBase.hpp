...
class ABP_MonsterBase_C : public APalMonsterCharacter
{
    ...
    class UPalAbilitySkillParameterComponent* PalAbilitySkillParameter;               // 0x09F8 (size: 0x8)
    class UMotionWarpingComponent* MotionWarping;                                     // 0x0A00 (size: 0x8)
    class UBP_PalCryComponent_C* BP_PalCryComponent;                                  // 0x0A08 (size: 0x8)
    class UPalPartnerSkillParameterComponent* PalPartnerSkillParameter;               // 0x0A10 (size: 0x8)
    class UPalNavigationInvokerComponent* PalNavigationInvoker;                       // 0x0A18 (size: 0x8)
    class UPalInteractableSphereComponentNative* BP_InteractableSphere;               // 0x0A20 (size: 0x8)
    class UPalFacialComponent* PalFacial;                                             // 0x0A28 (size: 0x8)
    TEnumAsByte<ECollisionChannel> CapsuleCollisionChannel;                           // 0x0A30 (size: 0x1)
    FName CollisionProfileNameCache;                                                  // 0x0A34 (size: 0x8)
    class UNiagaraComponent* FlyEffect;                                               // 0x0A40 (size: 0x8)
    double EffectiveAttackLogTimer;                                                   // 0x0A48 (size: 0x8)
    FBP_MonsterBase_COnInflictDamageEvent OnInflictDamageEvent;                       // 0x0A50 (size: 0x10)
