...
class UABP_NPC_Base_C : public UPalAnimInstance
{
    ...
    bool K2Node_PropertyAccess_11;                                                    // 0x2B38 (size: 0x1)
    bool K2Node_PropertyAccess_10;                                                    // 0x2B39 (size: 0x1)
    FRotator K2Node_PropertyAccess_9;                                                 // 0x2B40 (size: 0x18)
    FVector K2Node_PropertyAccess_8;                                                  // 0x2B58 (size: 0x18)
    FVector K2Node_PropertyAccess_7;                                                  // 0x2B70 (size: 0x18)
    FWeaponAnimationInfo K2Node_PropertyAccess_6;                                     // 0x2B88 (size: 0x258)
    FTransform K2Node_PropertyAccess_5;                                               // 0x2DE0 (size: 0x60)
    bool K2Node_PropertyAccess_4;                                                     // 0x2E40 (size: 0x1)
    bool K2Node_PropertyAccess_3;                                                     // 0x2E41 (size: 0x1)
    bool K2Node_PropertyAccess_2;                                                     // 0x2E42 (size: 0x1)
    bool K2Node_PropertyAccess_1;                                                     // 0x2E43 (size: 0x1)
    FVector K2Node_PropertyAccess;                                                    // 0x2E48 (size: 0x18)
    FWeaponAnimationInfo WeaponInfo;                                                  // 0x2E60 (size: 0x258)
    FVector2D VelocityXY;                                                             // 0x30B8 (size: 0x10)
    double Speed;                                                                     // 0x30C8 (size: 0x8)
    bool IsAim;                                                                       // 0x30D0 (size: 0x1)
    bool IsReloading;                                                                 // 0x30D1 (size: 0x1)
    bool isCrouch;                                                                    // 0x30D2 (size: 0x1)
    FRotator AimRotatorForSpine;                                                      // 0x30D8 (size: 0x18)
    bool IsEndJump;                                                                   // 0x30F0 (size: 0x1)
    bool IsValidSprintAnimation;                                                      // 0x30F1 (size: 0x1)
    bool IsSprint;                                                                    // 0x30F2 (size: 0x1)
    FTransform LeftHandTransform;                                                     // 0x3100 (size: 0x60)
    bool isAttachLeftHand;                                                            // 0x3160 (size: 0x1)
    class UPalShooterComponent* TSCache_ShooterComponent;                             // 0x3168 (size: 0x8)
    class APalCharacter* TSCache_OwnerPalCharacter;                                   // 0x3170 (size: 0x8)
